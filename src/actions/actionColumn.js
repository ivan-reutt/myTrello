import { ADD_COLUMN, DEL_COLUMN, EDIT_COLUMN, ADD_TASK, DEL_TASK, EDIT_TASK, DND_TASK_IN, DND_TASK_OUT, DND_COLUMN } from "../constants/actions";
...
export const dndColumn = (columns) => ({
    type: DND_COLUMN,
    columns
});
